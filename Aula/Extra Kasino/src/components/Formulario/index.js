...
export default class Formulario extends Component {
  handleSubmit = ({ nome, email, contato, mensagem }) => {
    ...
    if (errors.nome || errors.email || errors.contato || errors.mensagem) {
      ...
      Swal.fire({
        title: 'Tudo certo!',
        icon: 'success',
        text: 'Em breve entraremos em contato Can\'t get over you!'
      })
    }
  }
  ...
  render() {
    return (
      <>
        <div className="col-md-3 col-sm-8 my-3 container text-center">
          <h2>Contato</h2>
          <Formik initialValues={{ nome: '', email: '', contato: '', mensagem: '' }} onSubmit={this.handleSubmit}>
            <Form>
              ...
              <Field placeholder="Insira seu telefone (00) 00000-0000" type="tel" name="contato" id="contato" className="form-control" />
