...
export default class Contato extends Component {
  ...
  render() {
    return (
      <>
        <div id="contato" className="col-md-4 col-lg-3 col-sm-8 my-3 container text-center">
          <h2>Contato</h2>
          <Formik initialValues={{ nome: '', email: '', contato: '', mensagem: '' }} onSubmit={this.handleSubmit}>
            <Form>
              ...
              <Field placeholder="Insira sua mensagem" as="textarea" name="mensagem" id="mensagem" className="form-control my-2" />
